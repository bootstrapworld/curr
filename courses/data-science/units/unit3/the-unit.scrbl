...
@unit-overview/auto[#:lang-table (list (list "" @code{}))]{
  @unit-descr{Students are introduced to their first examples of operations that consume and produce tables.  Students will select columns from tables, and order columns from tables.  They will also learn to classify data as categorical or quantitative.}
}
@unit-lessons{
@lesson/studteach[
     #:title "Selecting"
