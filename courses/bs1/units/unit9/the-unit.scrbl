...
@lesson[#:title "Introduction"
      ...
      @itemlist[@item{@tag[pedagogy]{Students not finished with their games? You can use the last class to @(hyperlink "http://www.bootstrapworld.org/curriculum/BS1-sp2012/SupplementalLessons.html#games" "get things done"), with a speed-focused game designed to get things done! Got time for a challenge? Try introducing them to @(hyperlink "http://www.bootstrapworld.org/curriculum/BS1-sp2012/SupplementalLessons.html#structs" "Data Structures"), to allow for 2-dimensional motion and more player control.}}
                 ...
                 @item{@tag[pedagogy]{Hand out CD-ROMs or Flash Drives with their game folders, or links/QR codes to their shared WeScheme games. (It can be a real treat to give kids stickers with their "game barcodes" printed out on them!)}}
...
@lesson[#:title "Presentation Overview"
   ...
   @itemlist[
    ...
    @item{@tag[pedagogy]{On a poster or slideshow, flip through the following concepts and quiz kids to see what they remember about each: 
           @itemlist[
    ...
    @item{@tag[pedagogy]{Demo a terrible presentation, modeling bad posture, low volume, and mumbling. When it's time for the code-walk, stop. Ask kids to critique, pointing out what they liked and didn't like. What did they think of the speed of the presentation? Could they hear you? Then model a much better presentation! Demonstrate positive energy, clear speech, etc.}}
     ...
     @item{@tag[pedagogy]{Have students walk through some sample code for a game, and ask each student to explain one line of code as clearly as possible. Don't have them recite the code! Don't be afraid to push students to really explain what's going on.}}
]}
...
@lesson[#:title "Presentation Planning"
       ...
       @itemlist[
        ...
        @item{@tag[pedagogy]{Get each group to sign up for a concept: see @(hyperlink "bottom of page..." "signup sheet").}}
        ...
        @item{@tag[pedagogy]{Give students 15min to prepare, with a 5min countdown.}}
...
@lesson[#:title "Rehearsal"
        #:duration "30 min"]{
        @itemlist[@item{@tag[pedagogy]{Rehearse, give feedback. If there's time, rehearse again.}}]}
 
@lesson[#:title "Celebration, Closing"
        #:duration "20 min"]{
                             
        @itemlist[@item{Congratulations: you've done something really incredible! In the last nine weeks you've learned a new programming language, from scratch. You learned about the Circles of Evaluation, Numbers, Strings, Booleans, Images, Functions, Values, Conditional Branching, the Design Recipe, contracts, and more. You made a rocket fly, you learned how to generate computer graphics. Oh, and you built a videogame.}  
                   @item{@tag[pedagogy]{Have the class give each other a round of applause.}}
