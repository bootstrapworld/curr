...
@lesson/studteach[
     ...
     #:learning-objectives @itemlist[@item{Students will be able to explain the Circles of Evaluation to others.}
       ...
       @points[@point{@student{Once you have a working game (will all your Contracts and EXAMPLEs included, of course!), it's time to think about how to present your work to others. Programmers spend a lot of time designing and writing their code, but they also spend time explaining their work to others. These might be other programmers on their team, other engineers within the company, or even non-technical people. Do you think you can explain your code to someone else?}
                ...
                @point{@student{@activity{Create a sample poster for your game! Every poster should have the following:
                                          @itemlist[@item{Your name(s), and the title of your game}
                                                     ...
                                                     @item{A written description of ONE function from your code. This description should include the Name, Domain and Range of the function, with an explanation of what it does and how it is used in your game.}]}}
                       @teacher{Make sure that each group of students gets a different function to talk about, so that a classwide presentation will review the entire game. You may also want to have groups assigned to explain the Circles of Evaluation, Contracts, and the purpose behind the Design Recipe.}
                       }
                ...
                @point{@student{@activity{Write or practice a 5min presentation, in which you introduce yourself and explain your game, then walk the audience through an explanation of the function or concept you were assigned.}}
