        ...
        #:duration "25 minutes"]{
          @itemlist/splicing[@item{Welcome back! Do you remember what we did in the last class?}
           ...
           @item{Let's do a review challenge:
                 @itemlist/splicing[@item{Turn to @(hyperlink "http://page6.com" "Page 6") in your workbooks, where it says "Circles Competition." On each row there is a mathematical expression in the first column,
