...
@lesson/studteach[
     ...
     #:pacings (list 
       ...
       @points[@point{@student{Once you have a working game (will all your Contracts and EXAMPLEs included, of course!), it's time to think about how to present your work to others.
                                    Programmers spend a lot of time designing and writing their code, but they also spend time explaining their work to others.
                                    These might be other programmers on their team, other engineers within the company, or even non-technical people.
                                    Do you think you can explain your code to someone else?}
                ...
                @point{@student{@activity{Create a sample poster for your game! Every poster should have the following:
                                          @itemlist[@item{Your name(s), and the title of your game}
                                                     ...
                                                     @item{A written description of ONE function from your code. This description should include the Name, Domain and Range of the function,
                                                             with an explanation of what it does and how it is used in your game.  Instead of describing a function, you could describe some concept
                                                             you learned (Circles of Evaluation, Design Recipe, Piecewise Functions, Pythagorean Theorem) and how you used it in creating your game.}]}}
                       @teacher{Make sure that each group of students gets a different function to talk about, so that a classwide presentation will review the entire game.
                ...
                @point{@student{After you've made the poster, think about how you will use it during your presentation. What will you say to the audience?@slidebreak
                       ...
                       @teacher{Demonstrate a terrible presentation, modeling bad posture, low volume, and mumbling. When it's time for the code-walk, stop.
                                            ...
                                            Could they hear you? Then model a much better presentation! Demonstrate positive energy, clear speech, etc. }
                       }
                @point{@student{@activity{Write or practice a 5 minute presentation, in which you introduce yourself and explain your game, then walk the audience
...
@lesson/studteach[
     ...
     #:pacings (list 
       ...
       @points[@point{@student{Congratulations: you've done something really incredible! You've learned a new programming language,
                                                learned about the Circles of Evaluation, Numbers, Strings, Booleans, Images, Functions, Values,
                                                Conditional Branching, the Design Recipe, Contracts, and more. You made a rocket fly, you learned how to generate computer graphics,
                                                and you put all of that together to build a videogame!}  
