...
@lesson/studteach[
     ...
     #:pacings (list 
       ...
       @points[@point{@student{Suppose two objects are moving through space, each one having its own (x,y) coordinates.
                ...
                @point{@student{Scroll to the @code{line-length} and @code{collide?} functions in your game file. 
                                       Notice that @code{line-length} uses a conditional so that it subtracts the smaller number from the bigger one. 
                ...
                @point{@student{@bitmap{images/3004ABCgraph.png}Drawing a line from the center of one object to the other creates a right-triangle, with sides A, B and C.
                ...
                @point{@student{In a right triangle, the side opposite the 90-degree angle is called the @vocab{hypotenuse}. 
...
@lesson/studteach[
     ...
     #:pacings (list 
       ...
       @points[@point{@student{@noSlideText{Ancient civilizations had the same problem: they also struggled to find the distance between points in two dimensions!}
                ...
                @point{@student{@bitmap{images/csquared.png}For any right triangle, it is possible to draw a picture where the hypotenuse is used for all four sides of a square.
                ...
                @point{@student{@bitmap{images/absquare.png}The smaller square has an area of @math{A^{2}}, and the larger square has an area of @math{B^{2}}.  Since these squares are
                ...
                @point{@student{The code on @worksheet-link[#:name "distance-example"] will accurately calculate the distance between two objects whose centers are at (3,0) and (0,4). 
...
@lesson/studteach[
     ...
     #:pacings (list 
       ...
       @points[@point{@student{By now, you have defined a function called @code{distance}: it has four Number inputs (representing playerX, playerY, dangerX and dangerY) and
                                  produces a Number representing the distance between those coordinates.  If the player is standing at (320, 240) and the danger is at (400, 159),
                ...
                @point{@student{Now that you know how to compute the distance between two objects, you need to decide when two objects have collided. 
                                    We discussed this earlier in the unit using circles: two circles collide when the distance between them is less than the sum of their radii. 
                       ...
                       @teacher{You can spend additional time on this point by having students think about collision distances between different shapes. 
                ...
                @point{@student{Unless the images you chose for your game are very small, 50 pixels is usually a sufficient distance for detecting collisions between your player and danger.
