...
Lapiceros/lápices para los estudiantes, marcadores de pizarra para profesores}
                            ...
                            @item{Cartel de clase (Lista de reglas, tabla de lenguaje, calendario del curso)}
                            @item{Tabla de Lenguaje (Vea abajo)}]
     #:preparation @itemlist[@item{"Cage" [Cage.rkt de @(resource-link #:path "source-files.zip" #:label "source-files.zip") | @(hyperlink "https://www.wescheme.org/openEditor?publicId=0elP8WrmfM" "WeScheme")] precargado en las máquinas de los estudiantes.}]
