...
Now we have values, and we know how to define shortcuts for them. However, there are also plenty of pre-built functions, which let us play around with these values. 
@activity{What are some functions you know that work on numbers? How many can you list?}}
           ...
           @point{@student{You've seen some Racket code already, but do you remember the Circle of Evaluation? The Circles you to visualize the order of operations, and easily translate math expressions into Racket code? Let's review Circles of Evaluation!
