...
@lesson/studteach[#:title "Leveling up: Adding Levels"
        ...
        @points[@point{@student{You can add depth and more challenge to your game by adding levels. In this lesson, we'll cover making new levels based on the game's score. We want @editor-link[#:public-id "0B9rKDmABYlJVVkpkTmEyd1ZTaE0" "our Ninja Cat game"] to have a different background image when the player progresses to the next level. We'll say that the player reaches level two when his or her score is greater than 250.
