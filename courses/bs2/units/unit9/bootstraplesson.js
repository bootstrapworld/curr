...
/*******************************************
 * CARDS
 * when toggle-buttons are visible, allow them to manipulate the active card
 * TODO: disable prev/next buttons when at last/first card

var strip, cards = document.getElementsByClassName('lessonItem'), cardNum = 0;
...
function nextCard(){gotoCard(cardNum+1);}
function prevCard(){gotoCard(cardNum-1);}
