...
@lesson/studteach[#:title "Introduction"
        ...
        #:standards (list "N-Q" "7.EE.3-4" "8.G.6-8" "8.F.1-3" "A-SSE.1-2" "BS-M" "BS-IDE" "BS-PL.3" "BS-PL.4" "BS-DR.4" "BS-DS.1" "BS-R")
        #:materials @itemlist[]
        ...
        @points[@point{@student{The final addition that everyone will need in their games is collision detection! What should happen when your player collides with your danger, or target? Do you have a score as part of your world structure? Thankfully, you've already completed the Design Recipe for the functions you'll need to add to your game. @activity[#:forevidence (list "8.G.6-8&1&3" "8.F.1-3&1&1" "BS-IDE&1&1" "BS-PL.3&1&1" "BS-PL.3&1&2" "BS-PL.3&1&3")]{Turn to @worksheet-link[#:page 28 #:name "line-length"] in your workbook. Starting with @code{line-length}, add your @code{line-length}, @code{distance}, and @code{is-collision} functions into your game file.}}
                 ...
                 @point{@student{Now that you have all the necessary functions to check whether characters are colliding, you can add to your @code{next-world} function to modify the world when this happens. Remember what you wrote for the Ninja Cat game: first, you checked whether the cat and dog were colliding. Maybe you want to check if the player has reached a goal at certain coordinates, or if @italic{your} player and danger have collided. @activity[#:forevidence (list "N-Q&1&1" "7.EE.3-4&1&1" "8.G.6-8&1&1" "A-SSE.1-2&1&1" "BS-M&1&1" "BS-PL.3&1&3" "BS-PL.4&1&1" "BS-DR.4&1&3" "BS-DS.1&1&5" "BS-R&1&5")]{@itemlist[@item{What function checks if two thing are colliding?}
...
@lesson/studteach[#:title "Branches in next-world"
        ...
        #:evidence-statements @itemlist[]
        #:product-outcomes @itemlist[]
        #:standards (list "N-Q" "7.EE.3-4" "8.F.1-3" "F-IF.1-3" "F-LE.5" "A-SSE.1-2" "A-CED.1-4" "BS-M" "BS-PL.4" "BS-DR.2" "BS-DR.4" "BS-DS.1" "BS-R")
        #:materials @itemlist[]
        #:preparation @itemlist[@item{}]
        #:pacings (list 
                @pacing[#:type "remediation"]{@itemlist[@item{}]}
        ...
        @points[@point{@student{Now you've programmed your games to respond when different characters collide, and your games are almost finished! Think about what else you want to add: a scoring system? More dangers, targets, or players? Levels? Remember that for everything that @italic{changes} in your game, you'll need to add to your world structure, and this is your chance: @activity[#:forevidence (list "N-Q&1&1" "7.EE.3-4&1&1" "8.F.1-3&1&1" "F-IF.1-3&1&1" "F-LE.5&1&1" "A-SSE.1-2&1&1" "A-CED.1-4&1&1" "BS-M&1&1" "BS-PL.4&1&1" "BS-DR.2&1&1" "BS-DR.4&1&1" "BS-DR.4&1&2" "BS-DR.4&1&3" "BS-DS.1&1&5" "BS-R&1&1" "BS-R&1&5")]{Turn to @worksheet-link[#:page 42 #:name "Test and Result"] in your workbook and finish adding the things on your list to your game file.} Remember, if you want to change the @italic{appearance} of your games, you'll need to change your @code{draw-world} function to a piecewise function. You can write the tests and results you'll need for this function on @worksheet-link[#:page 44 #:name "Test and Result in draw-world"].}
