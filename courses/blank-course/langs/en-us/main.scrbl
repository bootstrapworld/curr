...
@main-contents{
@(elem #:style bs-coursename-style "Bootstrap:Blank")

 @; EDIT HEADING TEXT HERE

@boxed-text{@animated-gif{../../splash.png}Bootstrap:Blank (or "Bootstrap:1") applies mathematical concepts and rigorous programming principles to creating a simple videogame, and 
