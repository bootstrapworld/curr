...
@worksheet{@exercise{
    ...
    Write two examples of your function in action
     ...
     @struct-example-with-text["Kp1" 5] 
     
     @struct-example-with-text["Kp2" 5]
                     
                     
                         @worksheet-segment{III. Function Header}
    Write the function Header, giving variable names to all your input values.
    
    (define (@fill-in-the-blank[#:id "line-length1" #:label "function name" ] @fill-in-the-blank[#:id "line-length2" #:label "variable names" ])
    
    (cond
    
    @fill-in-the-blank[#:id "ll10" #:label "Condition1"]@fill-in-the-blank[#:id "ll11" #:label "Answer1" ]
    
        @fill-in-the-blank[#:id "ll12" #:label "Condition2" ]@fill-in-the-blank[#:id "ll13" #:label "Answer2" ]
