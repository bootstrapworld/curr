...
@lesson/studteach[#:title "The Distance Formula"
        #:duration "30 minutes"
        #:overview "Using the Pythagorean theorem and what they know from Bootstrap:Algebra, students write a distance function for their games"
        ...
        @points[@point{@student{So far, none of the animations we've created included any distance or collision-detection functions. 
                       ...
                       @teacher{This lesson is part of a series of features meant to come at the end of the Bootstrap:Reactive units. Once students 
