...
@worksheet{
    ...
    (define (@fill-in-the-blank[#:id "function name"] @fill-in-the-blank[#:id "variable names"])
     ...
     @fill-in-the-blank[#:id "COND1"]
     @fill-in-the-blank[#:id "COND2"]
     @fill-in-the-blank[#:id "COND3"]
     @fill-in-the-blank[#:id "COND4"]
     @fill-in-the-blank[#:id "COND5"]}



@section{Design Recipe: update-player}
@worksheet{
