...
@goals[@item{Learn about examples, variables and functions}
       @item{Practice Racket syntax and the Circle of Evaluation}]

Product Outcome
@goals[@item{Students@tag[group]{, in pairs,} will write functions to solve simple problems}
...
@lesson[#:title "Defining Variables" #:duration "10 minutes"]{
        ...
        @item{When you click Run, you'll see the title "My Game" at the top left hand corner of lyour new game}
        ...
        @item{Change the value of this variable form "My Game" to YOUR title. Then click Run, and see if the game is updarted to reflect the change}
...
triangle function, then a size, then tell the computer that I want it solid and green. I wish there was a shorter way, another function called gt
