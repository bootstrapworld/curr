...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname NinjaCatCatMove) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
