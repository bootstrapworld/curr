...
@lesson[#:title "Review"
        #:duration "20 minutes"]{
          @itemlist/splicing[
            ...
            @pedagogy{@item{MONITORS ON! You used all of this to make an autobody shop, where you had functions that would increase the auto's hp, or paint it a new color. This next problem's going to be even harder...so remember that the last two you wrote are written in your workbook, in case you need some hints.}}
