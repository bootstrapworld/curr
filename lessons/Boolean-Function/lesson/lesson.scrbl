...
@lesson[#:title "Boolean Functions" 
   ...
   @itemlist/splicing[
      ...
      @item{Tell me if the following statements are true or false:@itemlist/splicing[
             @item{Sugar is sweet: @fill-in-the-blank[#:id "bool1"]}
             @item{Ice is hot: @fill-in-the-blank[#:id "bool2"]}
             @item{Sugar is sweet @bold{and} Ice is cold: @fill-in-the-blank[#:id "bool3"]}
             @item{Sugar is sweet @bold{and} Ice is hot: @fill-in-the-blank[#:id "bool4"] @tag[pedagogy selftaught]{Why is it false? Isn't sugar still sweet?}}
             @item{Sugar is sweet @bold{or} Ice is cold: @fill-in-the-blank[#:id "bool5"]}
             @item{Sugar is sweet @bold{or} Ice is hot: @fill-in-the-blank[#:id "bool6"] @tag[pedagogy selftaught]{Why is it true? Ice isn't hot!}}]}
