...
@lesson[#:title "Boolean Function" 
   ...
   @itemlist/splicing[
      ...
      @item{@tag[pedagogy]{Pick up two, easily-distinguishable objects (a pen and an eraser, for example).} @tag[selftaught]{Pretend you are holding a pen and an eraser}  Tell me if the following statements are true or false:@itemlist/splicing[
             @item{I am holding a pen: @fill-in-the-blank[#:id "T/F"].}
             @item{I am holding an eraser: @fill-in-the-blank[#:id "T/F"]}
             @item{I am holding a pen AND an eraser: @fill-in-the-blank[#:id "T/F"] @tag[pedagogy]{Drop the pen}@tag[selftaught]{Now the pen is dropped.}}
             @item{I am holding a pen AND an eraser: @fill-in-the-blank[#:id "T/F"].}
             @item{I am holding a pen OR an eraser: @fill-in-the-blank[#:id "T/F"]. @tag[pedagogy]{Drop the eraser}@tag[selftaught]{Now the eraser is dropped.}}
             @item{I am holding a pen OR an eraser: @fill-in-the-blank[#:id "T/F"].}]}
