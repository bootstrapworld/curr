...
@lesson[#:title "Intro to Racket and Numbers"
  ...
  @itemlist/splicing[
   @pedagogy{@item{Draw a big Circle on the board.}}
   ...
   @item{Now we have numbers, which we can put in our Circle of Evaluation. @bitmap{images/1.3.png} @pedagogy{(Put in the number 4.)} What is the value of everything in this circle? Are you sure? @pedagogy{(Try other numbers, including decimals and negative numbers.)} @tag[selftaught]{Try other numbers, like 1.5, 10345017, and -2.}}
