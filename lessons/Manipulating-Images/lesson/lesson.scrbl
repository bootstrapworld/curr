...
@lesson[#:title "Manipulating Images"
  ...
  @itemlist/splicing[
    @tag[pedagogy]{@item{This section gets kids doing more than one level of circle, thus fitting contracts together and practicing the substitution model. You can get them to practice more than one level of circle using non-image things like (* 2 (+ 3 4)) and (+ (string-length "cat") 5), but changing images may be more compelling.}}
