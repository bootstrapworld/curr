...
@itemlist[@item{INSERT IMAGE OF MAP}
          @item{@think-about[#:question "What is the x-coordinate of your house?"
                             #:answer "0"]
                @think-about[#:question "What about the y-coordinate?"
                             #:answer "1"]}
          @item{@think-about[#:question "What is the x-coordinate of your grandpa's house?"
                             #:answer "0"]
                @think-about[#:question "What about the y-coordinate?"
                             #:answer "5"]}
          ...
          @item{@think-about[#:question "What is the x-coordinate of your friend's house?"
                ...
                @think-about[#:question "What about the y-coordinate?"
                             #:answer "1"]}
          @item{@think-about[#:question "How far away is your house from your friend's house?"
                             #:answer "3 miles"]}]