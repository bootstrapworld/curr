...
@lesson/studteach[
  ...
  @points[
     @point{@student{@bitmap{images/1.1.png} How does a computer know where to draw something on a screen? Suppose you had this picture of a dog on your screen and you were talking to a friend on the phone about what it looks like. How would you tell her @italic{exactly} where the Dog is? Would you just say "it's kind of on the right-hand side of the screen", or would you be more specific? What if you could use a ruler?}
      ...
      @point{@student{@bitmap{images/1.3.png} We can use a number line to figure out exactly how far something is from one side of the screen. Let's place the numberline so that the screen runs from 0 to 640. We can take the image of the NinjaCat, stick it anywhere on the line, and now we can all agree that the cat is standing at 5, 6, or any other number on our line. Number lines can also have negative numbers, so we can put NinjaCat off the left edge of the screen at -100, or off the right edge at 800 or 900.}
      ...
      @point{@student{What is the coordinate for the lower left-hand corner of the screen? What about the lower right-hand corner? The center? What part of the screen will NinjaCat be, if she's placed at (640, 0)? Can you think of a coordinate that puts her off the screen?}
              @teacher{}
              }
   ]}
