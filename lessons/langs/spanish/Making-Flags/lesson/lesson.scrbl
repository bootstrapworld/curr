...
@lesson/studteach[
     ...
     #:pacings (list 
        ...
        @points[
          @point{@student{@activity{Abre este archivo y lee el código: [@resource-link[#:path "source-files/Flags.rkt" #:label "DrRacket"] | @editor-link[#:public-id "5eyoC2lS47" "WeScheme"]]  El código también se muestra aquí:
