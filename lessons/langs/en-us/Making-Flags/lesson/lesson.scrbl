...
@lesson/studteach[
     ...
     #:pacings (list 
        ...
        @points[
          @point{@student{@activity{Open this file and read through the code: [@resource-link[#:path "source-files/Flags.rkt" #:label "DrRacket"] | @(hyperlink "https://www.wescheme.org/openEditor?publicId=5eyoC2lS47" "WeScheme")] The code is also shown here:
