...
@drill[]{
  @itemlist/splicing[
   ...
   @item{Suppose you have a quarter, but you want your friend's quarter. When he isn't looking, you quickly swap your quarter with your friend's quarter. What are the domain and range? What is the contract for @code{swap-quarter}? Remember that contracts show the TYPE of input and outputs, but NOT the actual input or output. @linebreak[]
   ...
   @item{You really want a chocolate bar, so you go to the vending machine. You put in your money and enter the code for the snack you want, and your chocolate bar drops out! What are the domain and range? What is the contract for @code{vending-machine}? @linebreak[]
    ...
    @item{It's time to do the laundry! You put your dirty clothes into the laundry machine and add detergent. You come back an hour later and get your clean clothes. What are the domain and range? What is the contract for @code{laundry-machine}? @linebreak[]
   ...
   @item{Suppose you buy a packet of seeds. You plant a handful in the garden and water it. A week later you see that your seeds have grown into plants! What are the domain and range? What is the contract for @code{grow-plant}? @linebreak[]
