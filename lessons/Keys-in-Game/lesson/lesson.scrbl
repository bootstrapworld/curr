...
@lesson[#:title "Keypresses in your Game"
        #:duration "35 minutes"]{
          @itemlist/splicing[
            @item{Turn to @worksheet-link[#:page 29 #:name "Key Brainstorm"] in your workbooks. In Ninja World, what keys could the user press? @code{"up"} and @code{"down"}. What field in the World changes when the player presses @code{"up"}? @code{catY}. What does it change by?}
