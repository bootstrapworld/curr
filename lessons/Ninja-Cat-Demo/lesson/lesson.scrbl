...
@lesson[#:title "Dissecting a Demo"
 ...
 @itemlist[
   ...
   @item{@tag[pedagogy]{@demo{Show the kids Ninjacat.}Be sure to end on a frozen frame of the game, so the whole class can see the same image.}@tag[selftaught]{Look at the demo of Ninjacat and click run. @embedded-wescheme[#:id "NinjaCat"
