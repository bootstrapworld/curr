...
@lesson[#:title "Dissecting a Demo"
 ...
 @itemlist/splicing[
   ...
   @item{Let's take a look at a real game, which I've made using the same language and tools that you'll  be learning. When you're done with this class, you'll be able to make something similar. @bitmap{images/1.2.png}}
