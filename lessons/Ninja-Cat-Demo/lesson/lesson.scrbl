...
@lesson[#:title "Dissecting a Demo"
 ...
 @itemlist/splicing[
   ...
   @tag[pedagogy]{@demo{@item{Show the kids Ninjacat.}Be sure to end on a frozen frame of the game, so the whole class can see the same image.}}
   ...
   @tag[group]{@exercise{@item{In your groups:} Take one minute to fill in the second column, for each thing in your game. GO!}}
