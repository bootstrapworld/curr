...
@drill{
  @itemlist[
    @item{Try out this simple coloring game!}
     ...
     @item{What is constantly changing in the game, even when you are not doing anything? @linebreak[]
     ...
     @item{In which direction(s) can the player-controlled object move (with only one keystroke)? @linebreak[]
     ...
     @item{What happens in the game constantly, even when you are not doing anything? @linebreak[]
