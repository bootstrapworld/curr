...
@lesson[#:title "Introducing Structs"
        #:duration "10 minutes"]{
          @itemlist/splicing[@tag[pedagogy]{@item{Pass out the bags of datatype cards.}
            ...
            @tag[pedagogy]{@item{Set aside the two number cards; one for the x and one for the y coordinates. Then pick up your plastic bags.}}
            @tag[pedagogy]{@item{Put the two number cards inside the plastic bag, and then hold it up. How many things are you holding? One!}}
            ...
            @tag[pedagogy]{@item{Good job guys! Put all of your cards back in the bag and leave it on the table.}}]}