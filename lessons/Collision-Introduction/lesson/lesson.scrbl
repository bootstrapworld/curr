...
@lesson[#:title "Introduction" 
        ...
        @itemlist/splicing[@item{Review previous material.}
                  ...
                  @tag[pedagogy]{@item{I need to know how far apart I am from the danger, so I'll know when we've collided. Can anyone tell me how far apart we are? Have we collided?}}
                  @tag[pedagogy]{@item{Take a step forward. How far are we now? Have we collided? Repeat until you collide.}
                  ...
                  @tag[pedagogy]{@item{Demonstrate this on the board, using a number line. Ask the following questions, filling in the blanks for contract as students give answers:}}
                 ...
                 @tag[pedagogy]{ @item{@skit{I'd like to have one volunteer stand up and be our function. Raise your hand if you'd like to volunteer! Your name is now "line-length". Whenever I call your name, I will also give you two numbers, and your job is to tell me the difference between them - just like the code on the board! Let's try one example "line-length twenty ten!" your volunteer should reply with "ten." Raise your hand if you'd like to try! Take some volunteers, and make sure line-length is doing the right thing (including bugs if the first number is smaller than the second!).}}}
                 ...
                 @item{@think-about[#:question @list{What does this function do? @tag[pedagogy]{Raise your hand if you have an idea.}}]}
                 ...
                 @tag[pedagogy]{@item{@skit{I'd like to have one volunteer stand up and be collide? Raise your hand if you'd like to volunteer!
