...
@lesson[#:title "More dissection"
 ...
 @itemlist/splicing[
    ...
    @tag[pedagogy]{@item{Terrific! Great job, all of you. }Now, turn to @(hyperlink "page2.com" "page 2") in your game planning workbooks and look at the project sheet that has a picture of the NinjaCat game you just saw.}
