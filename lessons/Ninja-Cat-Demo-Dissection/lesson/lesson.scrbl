...
@lesson[#:title "More dissection"
 ...
 @itemlist/splicing[
   ...
   @tag[selftaught]{@item{If you already feel confident with coordinates, you may skip ahead to the next section. If you would like more practice:}}
                     
   @item{Turn to @worksheet-link[#:page 2 #:name "Ninja-Cat-Coordinates"] in your game planning workbooks and look at the project sheet that has a picture of the NinjaCat game you just saw.}
    ...
    @item{@exercise{@tag[group]{In your groups:} Take a minute to find and label all of the midpoints - the points in the middle of each side of the screen: top, bottom, left and right. @pedagogy{(You may want to point to these points on the board). @tag[group]{ Once again, your group only gets a point if everyone writes and labels these coordinates correctly. GO! }}}}
