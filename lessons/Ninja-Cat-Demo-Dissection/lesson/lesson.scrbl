...
@lesson[#:title "More dissection"
 ...
 @itemlist/splicing[
    @item{So let's look back at our table @worksheet-link[#:page 1 #:name "How-Does-Ninja-Cat-Work" #:lesson "Ninja-Cat-Demo"]. Now that we know what a position is, let's be more specific about what is changing during the game.}
