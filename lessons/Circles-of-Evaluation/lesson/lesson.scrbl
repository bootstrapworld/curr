...
@lesson/studteach[
     ...
     #:pacings (list 
        ...
        @points[
                @point{@student{Math is a language, just like English, Spanish, or any other human language. We use nouns, like "bread", "tomato", "mustard" and "cheese". Math has @vocab{values}, like the numbers "1", "2" or "3". We have verbs like "toast", "slice", "spread" and "melt". Mathematics has @vocab{functions} like addition and subtraction. If you were to write instructions for making a sandwich, it would matter very much which came first: melting the cheese, slicing the bread, spreading the mustard, etc. The order of functions matters in mathematics, too. If someone says "four plus two minus one", they could mean several things:
                        ...
                        @teacher{<Discussion of the utility of Circles of Evaluation as a way of exploring structure and language. We're using programming languages to show students why the language of math has it's own structure. Explain why this is a good assessment.>}
                        }
