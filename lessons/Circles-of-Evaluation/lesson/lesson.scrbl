...
@lesson[#:title "Circles of Evaluation"
 ...
 @itemlist/splicing[
   ...
   @exercise{@item{Try writing this in the Interactions window, and hit "enter". What did you end up with? Now try writing in the complex example we used. Did you get the same answer?
   ...
   @tag[pedagogy]{@item{Have students practice circles - make it into a game!} There are several excercises provided on @(hyperlink "page4.com" "page 4") of the student workbook.}]}