...
@title{safe-left?}
@worksheet{
@design-recipe-exercise["safe-left?" "Use the Design Recipe to write a function " @code{safe-left?} ", which takes in the target's x-coordinate and checks to see if it is greater than -50."]
}
@;@worksheet{
