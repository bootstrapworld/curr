...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lesson) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
#lang curr/lib
        ...
        #:duration "25 minutes"]{
          @itemlist/splicing[@item{Welcome back! Do you remember what we did in the last class?}
           ...
           @item{Let's do a review challenge:
                 @itemlist/splicing[@item{Turn to @worksheet-link[#:page 6 #:name "Circles-of-Evaluation-Practice"] in your workbooks, where it says "Circles Competition." On each row there is a mathematical expression in the first column,
