...
@lesson[#:title "Defining Functions"
  ...
  @itemlist/splicing[
            ...
            @item{@code{g(q) = q * 6}}
            @tag[pedagogy]{@item{Have students translate the rest of the functions, 
                                 listed on @worksheet-link[#:page 35 #:name "Translating into Algebra.."].}}
            @item{Okay, so you're pretty good at translating from code to math. Do you think you can 
                  translate from math back into code?}
            @tag[pedagogy]{@item{1...2...3 Monitors ON!!!}}
            @item{On your computers, there are five examples of functions written in algebra. Under each one,
                  I want you to convert the algebraic function into code. @tag[pedagogy]{You will have five minutes - GO!}}
