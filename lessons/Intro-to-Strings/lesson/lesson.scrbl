...
@itemlist/splicing[@item{One of the following does not belong. Can you find it? 6, "cat", 0, -2, 7.5}
           ...
           @tag[pedagogy]{@item{Now that the students have written down the contract, let them turn on their monitors and experiment, see if they can figure out what string-length does!}}
