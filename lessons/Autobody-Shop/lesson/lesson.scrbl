...
@lesson[#:title "Autobody Shop"
        #:duration "30 minutes"]{
          @itemlist/splicing[
           ...
           @item{Turn to page 9 in your workbooks. @tag[pedagogy]{I know that you're really good at the design recipe by now, so I want you to fill out the page as we talk. Make sure they're able to keep up, and take time to let them write if need be!}}
           ...
           @item{Turn to page 10 in your workbooks.@tag[pedagogy]{ Now it's your turn.}}
