...
@lesson[#:title "Introduction"
        #:duration "15 minutes"]{
          @itemlist/splicing[
           ...
           @item{Draw a box on the board with @code{(make-world 0 640)} in it, labelled "world". Ask for a volunteer, and hang the update-world nametag around their neck.}
           @item{You're going to be @code{update-world}. What is your contract? And what do you do? Excellent. This box is your world. If I were to say @code{(update-world (make-world 0 640))}, what would you change about this world? The student should erase the 0 and write a 10, and erase the 640 and write a 635. If they are stuck, refer to the code.}
           @item{Let's practice this a few times: "update-world this world"...20 630..."update-world this world"...30 625. Excellent.}
           @item{Now I need another volunteer. Take one student, and put the big-bang sign around them. Your name is @code{big-bang}, do you remember what you're doing? You're sort of like the quarterback here. You start the whole animation, and you have a timer. The class will yell "tick!" every five seconds, you're going to tell @code{update-world} to update the world, just like I did. Let's try it out - every five seconds, I want you to give the current world to @code{update-world}, who will then update it and replace it with the new world. Ready? GO!}
           ...
           @item{I need another volunteer! Take one student, and put the draw-world sign around them. You guessed it! Your name is @code{draw-world}. Whenever you are evaluated, you'll be given a World and you'll have to place the image of the dog and the ruby at the appropriate spots.}
           ...
           @item{Okay, now let's put it all together! Return the World value to 0 640. @code{big-bang}, I want to call out "update-world this world" and "update-world this world". Try it out! Make sure the World is updated to 10 595, and the dog is drawn at 10, the ruby at 595. What's the value of our world now? 10 595! So what do you do? You call out "update-world this world" and "draw-world this world".}
           @item{When I say GO, the class will call out "tick" every five seconds. @code{big-bang}, what will you do every time you hear that? Let big-bang explain. Okay - let's do it!}
           ...
           @item{I want Ninja Cat to be right in the center of the screen. What does that make his y-coordinate? 240. @code{update-world}, can you change the world to have another space, starting at 240? @code{draw-world}, where are you going to put the cat? @code{big-bang}, does your job change? Nope! Alright...let's play the game. Let a few iterations pass...the cat doesn't move}
