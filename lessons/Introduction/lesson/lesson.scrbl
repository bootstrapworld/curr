...
@lesson[#:title "Introduction"
        #:duration "5 minutes"]{
      @itemlist/splicing[@item{Welcome back to college, guys.}
      @item{Introduce teaching staff. Have students introduce themselves as well.}
      ...
      @item{I want to know how much you guys remember from Bootstrap 1, so we're going to have a bit of a competition today.}]}