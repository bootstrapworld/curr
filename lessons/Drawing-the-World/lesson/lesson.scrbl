...
@lesson[#:title "Drawing the World"
        #:duration "40 minutes"]{
          @itemlist/splicing[
             @item{Now that we've got our world structure, we need to know how to draw it. Turn to  @worksheet-link[#:page 23 #:name "Drawing START"], and fill in your @code{START} world at the bottom. Once you have that done, do a simple sketch of your @code{START} world. According to your world struct, where should everything be when the game starts? @tag[pedagogy]{Take one minute and do that now. Be sure to count down!}}
