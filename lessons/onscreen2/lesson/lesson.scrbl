...
@lesson[#:title "onscreen? 2.0" 
     ...
     @itemlist/splicing[
         ...
         @item{There's more to being a writer than putting down grammatically-correct sentences. There's more to being an architect or an artist than building a bridge or coloring in a canvas. All of these disciples involved an element of @italic{design}.}
