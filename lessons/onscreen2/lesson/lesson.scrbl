...
@lesson[#:title "onscreen? 2.0" 
     ...
     @itemlist/splicing[
         ...
         @tag[pedagogy]{@item{I need a volunteer to be the @code{onscreen?} function. (take a volunteer)}}
         ...
         @tag[pedagogy]{@item{When I yell out "onscreen? fifty", @code{onscreen?} is going to call @code{protect-left} and @code{protect-right} with that number. Depending on what they give back, @code{onscreen?} will tell me true or false}}
