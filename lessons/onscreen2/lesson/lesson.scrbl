...
@lesson[#:title "onscreen? 2.0" 
     ...
     @itemlist/splicing[
         ...
         @item{Sam is onscreen only when he is safe on the left AND the right. How can we use one of those functions we just learned to do this? @pedagogy{'d like my volunteers safe-left and safe-right to stand up.}}
