...
@lesson[#:title "Collide?"
        #:duration "10 minutes"]{
          @itemlist/splicing[
            ...
            @pedagogy{@item{Using visual examples, ask students to guess the distance between an danger and a player at different positions. How far apart do they need to be before one has hit the other?}}
