...
@lesson[#:title "Collide?"
        #:duration "10 minutes"]{
          @itemlist/splicing[
            ...
            @item{At the top of page 39 you'll find the Problem Statement for @code{collide?}. Fill in the Design Recipe, and then write the code. Remember: you WILL need to make use of the @code{distance} function you just wrote!}
