...
@lesson[#:title "Introducing the Design Recipe"
  ...
  @itemlist/splicing[
     ...
     @tag[pedagogy]{@item{How many of you know what a flip-book animation is? Explain if necessary.}}
     ...
     @tag[pedagogy]{@item{@skit{Who would like to volunteer to @italic{act out} this function?
     ...
     @item{Once you are done, you @tag[group]{and your partner} can type this function into your computer@tag[group]{s}.
                                  @tag[selftaught]{@embedded-wescheme[#:id "example3"
                                                     #:public-id "drawl-youth-fifty-voter-shake"
                                                          #:interactions-text ""]}}
     @item{@tag[pedagogy]{Do you guys want to see the rocket fly?} Type @code{(start rocket-height)}
