...
@design-recipe-exercise["rocket-height" "A rocket blasts off, traveling at 7 meters per second. Write a function called " @code{rocket-height} " that takes in the number of seconds that have passed since the rocket took off, and which produces the height of the rocket at that time."]
