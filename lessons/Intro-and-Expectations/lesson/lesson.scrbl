...
@lesson[#:title "Introduction and Expectations"
  ...
  @itemlist/splicing[
            ...
            @tag[pedagogy]{@item{Introduce the teaching staff. Give some background: age, where you're from, something surprising about yourself, favorite food, etc. Anything to allow kids to connect. Ask kids for their names!}}
            @tag[pedagogy]{@item{I want to set some expectations here, to make sure we're all on the same page.}}
           ...
           @tag[pedagogy group]{ @item{Right now, all of you are sitting with your group, clustered together around the classroom. When it comes time for team competitions or group activities, you'll be working with the people sitting nearby.}}
            ...
            @tag[pedagogy group]{@exercise{@item{Assign group names (tip: use names that have something to do with computer science, or college, etc)}}}]}
