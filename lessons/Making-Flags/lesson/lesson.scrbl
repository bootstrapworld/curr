...
@lesson/studteach[
     ...
     #:pacings (list 
        ...
        @points[
          @point{@student{@activity{Open this file and read through the code: [@resource-link[#:path "source-files/Flags.rkt" #:label "DrRacket"] | @(hyperlink "http://www.wescheme.org/view?publicId=M1BlnSmlbX" "WeScheme")] The code is also shown here:
