...
@lesson[#:title "The Distance Formula"
        #:duration "20 minutes"]{
          @itemlist/splicing[
            ...
            @item{Turn to page 37 of your workbook - you'll see the formula written out. @tag[pedagogy]{Let's do this one together, since it's been a long time since we've done Circles of Evaluation as a class.}}
