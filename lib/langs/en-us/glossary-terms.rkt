...
|#
  ...
  (("accessor functions" "functions to extract values from a data structure")
    ...
    ("quartiles" "Numbers that divide a a data set into four, equally-sized groups. The lowest quartile (Q1) is the middle of the bottom half of the data. Q2 (the median) is the middle of the entire sample. Q3 is the middle of the top half of of the data.")
