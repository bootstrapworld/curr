...
function showSlides() {
  ...
  var cardNodes = document.querySelectorAll(".student").filter(function(card) {
      	card.getElementsByClassName('BS-Skip-Slide').length == 0}), //,.BootstrapPageTitle
      cards     = [].slice.call(cardNodes), // convert NodeList to Array, remove slides to be skipped
