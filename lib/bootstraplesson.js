...
function initializeCards(){
  ...
  var lessons = document.getElementsByClassName('LessonBoundary'),
      cards   = document.getElementsByClassName('lessonItem');
      lesson    = document.getElementsByClassName('lesson')[0];
  // attach buttons to this lesson
  lesson.prev    = document.getElementsByClassName('prev')[0];
  lesson.next    = document.getElementsByClassName('next')[0];
  ...
  for(var j=0; j < cards.length; j++){ lesson.appendChild(cards[j]); }
